...
Model regresi spasial digunakan untuk mengetahui hubungan antara satu peubah dengan satu atau lebih peubah dengan memperhatikan adanya efek spasial [@cahyati2018]. Persamaan umum untuk model regresi spasial dapat dirumuskan sebagai berikut [@griffith1988]:
