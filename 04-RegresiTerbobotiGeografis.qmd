...
\begin{tabular}{|c|p{8cm}|}
  ...
  X1 & PDRB (Milyar) \\
  \hline
  X2 & Persentase masyarakat tamat SD kebawah (\%) \\
  \hline
  X3 & Angka melek huruf (\%) \\
  \hline
  X4 & Pengeluaran perkapita (\%) \\
  \hline
  X5 & Banyak rumah tangga penerima raskin (\%) \\
  \hline
  X6 & Penduduk kelompok umur 15-64 (\%) \\
  \hline
  X7 & Harapan lama sekolah (tahun) \\
  \hline
\end{tabular}
\end{table}
$$
...
Berdasarkan nilai selang nilai tersebut, data kemiskinan dipetakan dengan menggunakan syntax sebagai berikut:
